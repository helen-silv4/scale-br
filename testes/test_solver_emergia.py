...
@pytest.fixture
def matriz_exemplo():
    """Fixture com matriz de teste padrão."""
    return pd.DataFrame({
...
class TestSolverEmergia:
    ...
    def test_calcular_retorna_resultados(self, matriz_exemplo):
        """TU04 — Cálculo retorna resultado para cada processo."""
    ...
    def test_regra_coproduto(self):
        """TU04 — Emergia total atribuída integralmente ao co-produto."""
    ...
    def test_regra_feedback(self):
        """TU05 — Fluxo de feedback expandido corretamente."""
        solver = SolverEmergia(pd.DataFrame(), {})
        emergia = 1.00e+15
    ...
    def test_caminho_multiplo_seleciona_maior(self):
        """TU06 — Apenas o maior valor é selecionado entre caminhos paralelos."""
        solver = SolverEmergia(pd.DataFrame(), {})
    ...
    def test_transformador_aplicado(self, matriz_exemplo):
        """Verifica se o transformador emergético é aplicado corretamente."""
    ...
    def test_exibir_resultados_sem_calculo(self):
        """Verifica mensagem quando resultados estão vazios."""
        solver = SolverEmergia(pd.DataFrame(), {})
